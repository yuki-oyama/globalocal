"""
Estimation code for global-local model
Author: Yuki Oyama (oymyk.dom@gmail.com)
"""
...
gen_arg.add_argument('--net_name', type=str, default='SiouxFalls', help='network name')
...
model_arg.add_argument('--vars_g', nargs='+', type=str, default=['length'], help='explanatory variables')
model_arg.add_argument('--init_beta_g', nargs='+', type=float, default=[-1.], help='initial parameter values')
model_arg.add_argument('--lb_g', nargs='+', type=float_or_none, default=[None], help='lower bounds')
model_arg.add_argument('--ub_g', nargs='+', type=float_or_none, default=[0.], help='upper bounds')
model_arg.add_argument('--vars_l', nargs='+', type=str, default=['caplen'], help='explanatory variables')
...
if __name__ == '__main__':
    ...
    # define attributes (for the synthetic dataset: only length and capacity are available)
    ...
    # prepare data for estimation by reading observations (map-matching results in the case of real application)
